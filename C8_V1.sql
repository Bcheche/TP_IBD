...
select cp.condicao_codigo_icd, r.sintoma_codigo_ctcae 
from relato_sintoma_paciente r
join paciente p on  r.paciente_cpf = p.cpf
join condicao_paciente cp on cp.paciente_cpf = p.cpf
where  r.gravidade >=4 and r.iniciado_em >= '2010-01-01'